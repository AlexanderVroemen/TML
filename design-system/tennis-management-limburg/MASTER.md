...
**Project:** Tennis Management Limburg
**Generated:** 2026-09-10 16:21:45
...
|------|-----|--------------|
| Primary | `#236B45` | `--color-primary` |
| On Primary | `#FFFFFF` | `--color-on-primary` |
| Secondary | `#0D2D21` | `--color-secondary` |
| On Secondary | `#FFFFFF` | `--color-on-secondary` |
| Accent/CTA | `#EFFF67` | `--color-accent` |
| On Accent/CTA | `#0D2D21` | `--color-on-accent` |
| Background | `#F5F4ED` | `--color-background` |
| Foreground | `#122119` | `--color-foreground` |
| Card | `#FFFFFF` | `--color-card` |
| Card Foreground | `#122119` | `--color-card-foreground` |
| Muted | `#E9EEE9` | `--color-muted` |
| Muted Foreground | `#647168` | `--color-muted-foreground` |
| Border | `#D8DDD6` | `--color-border` |
| Destructive | `#236B45` | `--color-destructive` |
| On Destructive | `#FFFFFF` | `--color-on-destructive` |
| Ring | `#EFFF67` | `--color-ring` |

**Color Notes:** TML-groen uit de bestaande huisstijl, verdiept met bosgroen en gecombineerd met een tennisbal-limoen voor CTA’s. Geen gradients als decoratie; alleen functionele beeld-overlays.

### Typography

- **Heading Font:** Arial Narrow / Aptos Narrow (system fallback)
- **Body Font:** Inter / Helvetica Neue (system fallback)
